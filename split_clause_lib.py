from config import MAX_INPUT_LENGTH, MAX_NEW_TOKENS_SPLIT, DEBUG_MODE

def chat(model, tokenizer, messages, max_new_tokens=MAX_INPUT_LENGTH) -> str:
    """
    Hàm chat với LLM model.
...
def chat_gguf(model, messages, max_new_tokens=MAX_INPUT_LENGTH) -> str:
    """
...
def split_sentence_with_terms_llm(sentence, model, tokenizer, max_new_tokens=MAX_NEW_TOKENS_SPLIT):
    """
