...
def split_and_term_extraction(sentence, model, tokenizer, max_new_tokens=MAX_NEW_TOKENS_SPLIT):
    clauses = split_sentence_with_terms_llm(sentence, model=model, tokenizer=tokenizer, max_new_tokens=max_new_tokens)
    if clauses:
